...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            arduinoData.setText(text);
            Log.d("BTReceiver", "Received BT data" + text);
            int temp = text.lastIndexOf('#');
            String data = text.substring(temp + 1);
            if (Sign.mDatabase.containsKey(data)) {
                Sign sign = Sign.mDatabase.get(data);
                if(!sign.getSignName().equals(signName.getText().toString())) {
                    signImage.setImageResource(sign.getImageResourceId());
                    signName.setText(sign.getSignName());
                    ...
                    if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                        ...
                        mMediaPlayer = MediaPlayer.create(MainActivity.this, sign.getAudioResourceId());
